...
module.exports = class CallCreateEvent extends BaseEvent {
  ...
  callDelete: `// https://abal.moe/Eris/docs/Client#event-callCreate
const BaseEvent = require("../utils/structures/BaseEvent");

module.exports = class CallDeleteEvent extends BaseEvent {
  constructor() {
    super("callDelete");
  }
  ...
  callRing: `// https://abal.moe/Eris/docs/Client#event-callCreate
const BaseEvent = require("../utils/structures/BaseEvent");

module.exports = class CallRingEvent extends BaseEvent {
  constructor() {
    super("callRing");
  }
